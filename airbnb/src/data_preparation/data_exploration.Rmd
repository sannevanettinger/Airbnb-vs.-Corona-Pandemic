...
library(tidyr)
listings_london_qrt2 %>% drop_na(review_scores_rating)

preObj <- preProcess(listings_london_qrt1[62], method=c("center", "scale" ), na.rm = TRUE)
newData <- predict(preObj, listings_london_qrt1[62])

summary(listings_london_qrt2)
preObj_2 <- preProcess(listings_london_qrt2[62], method=c("center", "scale"))
newData_2 <- predict(preObj_2, listings_london_qrt2[62])

listings_london_qrt1$reviews_standardized <- newData
listings_london_qrt2$reviews_standardized <- newData_2


listings_london_qrt1[62]
listings_london_qrt1[76]
summary(listings_london_qrt2$review_scores_rating)
summary(listings_london_qrt1$reviews_standardized)
summary(listings_london_qrt2$reviews_standardized)
