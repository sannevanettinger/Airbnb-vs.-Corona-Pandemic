...
* room_type
* calculated_host_listings_count **OR** host_listings_count
...
------
Note Claudia: Create new dataset with the needed variables, those mentioned above, name dataset = data_airbnb_uk_cleaned_1. Also might give a short description of what the variables are. 
------
Note: Decide which one to keep as there is a big difference between "calculated_host_listings_count" and "host_listings_count". "calculated_host_listings_count" being how many room (sometimes multiple type of rooms) a host offers. "host_listings_count" being ??
------
