...
data_airbnb_uk_cleaned <- data_airbnb_uk %>% 
  data_airbnb_uk_cleaned$quarter <- get_quarter(data_airbnb_uk$last_scraped) %>% 
  data_airbnb_uk_cleaned$year <- get_year(data_airbnb_uk$last_scraped) %>% 
  data_airbnb_uk_cleaned$year_quarter <- as.yearqtr(data_airbnb_uk$last_scraped, format="%Y-%m-%d") %>% 
  data_airbnb_uk_cleaned$year_quarter <- format(data_airbnb_uk_cleaned$year_quarter, format = "%Y-%q")
```
